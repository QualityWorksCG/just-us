...
import { Separator } from "@just-us/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@just-us/ui/components/sheet";
...
import { useIsMobile } from "@just-us/ui/hooks/use-mobile";
	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"relative w-(--sidebar-width) bg-transparent transition-[width] duration-[var(--dur-pop)] ease-[var(--ease-progress)] motion-reduce:transition-none",
			...
			<div
				...
				data-side={side}
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[var(--dur-pop)] ease-[var(--ease-progress)] data-[side=right]:right-0 data-[side=left]:left-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] motion-reduce:transition-none md:flex",
...
function SidebarGroupLabel({
	...
	return useRender({
		...
		props: mergeProps<"div">(
			{
				className: cn(
					"flex h-8 shrink-0 items-center rounded-none px-2 text-sidebar-foreground/70 text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-[var(--dur-pop)] ease-[var(--ease-progress)] focus-visible:ring-2 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 motion-reduce:transition-none [&>svg]:size-4 [&>svg]:shrink-0",
					className,
				),
			},
			props,
