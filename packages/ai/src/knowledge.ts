...
export const HELP_SECTIONS: HelpSection[] = [
	...
	},
	{
		...
		body: "The case wizard has five steps: Your story (what happened, plus evidence files or links), The basics (category, state, title, cover image and photos), Representation (add an attorney you already have, or publish out to attorneys), Attorney & fee (the fee agreed together, which becomes the funding goal), and Review & publish. It is free to start, saves as you go, and takes around ten minutes. Nothing is public until the plaintiff publishes. AI helpers can refine the story wording and suggest titles, and can flag what a story is missing — they never block publishing and never decide anything.",
	},
	{
		slug: "case-statuses",
		title: "Case statuses and what each means",
		body: "A case is a draft while it is in progress and private to its owner. It is seeking once it has been published out to attorneys with no attorney attached yet — attorneys can read it and request it, and the plaintiff chooses who takes it on. It is live once an attorney and fee are set and it is funding publicly. It is closed once it is resolved and no longer funding. A removed case is soft-deleted: it moves to the plaintiff's Deleted list and can be restored, so nothing is lost.",
	},
	{
