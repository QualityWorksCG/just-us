		...
		>
			...
			<section>
				...
				<p>
					...
					directly to an account held by the case's designated recipient —
					either the plaintiff or their retained attorney, as stated on the case
					page. JustUs never takes custody of donated funds and does not receive
					or store your payment credentials.
				</p>
			</section>
