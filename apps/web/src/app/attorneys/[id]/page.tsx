						...
						<Card>
							<div className="flex flex-col gap-5 sm:flex-row sm:items-start">
								...
								<div className="min-w-0">
									<h1 className="font-extrabold text-[26px] text-ink tracking-[-0.02em]">
										{attorney.legalName}
									</h1>
						...
						{attorney.caseRecords.length > 0 && (
							<Card>
								...
								<p className="mt-4 rounded-[var(--radius-card-sm)] bg-paper-alt px-4 py-3 text-[12.5px] text-muted-foreground leading-relaxed">
									...
									Self-reported by the attorney; JustUs verifies bar standing,
									not case histories.
								</p>
							</Card>
						)}
						...
						<Card>
							...
							<ul className="mt-3 flex flex-col gap-3">
								...
								<li className="flex items-start gap-2.5 text-[13px] text-ink-soft leading-relaxed">
									...
									/>
									<span>
										Chosen by plaintiffs on JustUs — case counts appear here
										once matters close.
									</span>
								</li>
								<li className="flex items-start gap-2.5 text-[13px] text-ink-soft leading-relaxed">
									...
									/>
									<span>
										Funds settle to a case-specific account — never to JustUs.
									</span>
								</li>
							</ul>
						</Card>
