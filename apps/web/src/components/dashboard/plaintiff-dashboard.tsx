	...
	return (
		<div className="flex items-start gap-2.5 rounded-[var(--radius-card)] border border-border bg-surface/60 px-5 py-3.5 text-[12.5px] text-ink-soft leading-relaxed">
			<HandCoins
				...
				aria-hidden="true"
			/>
			Donations fund the agreed fee and land in the account your case designates
			— yours, or the attorney's if they receive directly. One transparent 5%
			fee, shown to each donor before they give.
		</div>
	);
}
